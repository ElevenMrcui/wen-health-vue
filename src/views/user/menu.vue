    ...
    <div class="app-container">
      <div class="box">
        <div class="filter-container">
          <el-input
            placeholder="项目编码/项目名称"  v-model="pagination.queryString" style="width: 200px"  class="filter-item" ></el-input>
        ...
        >
          ...
          <el-table-column prop="linkurl" label="请求地址"  align="center"> </el-table-column>

          <el-table-column prop="path" label="路径"  align="center" ></el-table-column>

            <el-table-column prop="icon" label="图像" align="center"></el-table-column>
        ...
        <!-- 编辑标签弹层 -->
        <div class="add-form">
          <el-dialog title="菜单编辑" :visible.sync="dialogFormVisible4Edit">
            <el-form
              ref="dataEditForm"
              :model="formData"
              :rules="rules"
